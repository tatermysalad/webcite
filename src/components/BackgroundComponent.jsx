                                    ...
                                    <div className="hidden md:block">
                                        <div className="ml-4 flex items-center md:ml-6">
                                            ...
                                            <Menu as="div" className="relative ml-3">
                                                <div>
                                                    <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-teal-500 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-teal-500">
                                                ...
                                                >
                                                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-purple-600 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                                ...
                                                                {({ active }) => (
                                                                    <a
                                                                        ...
                                                                        className={classNames(
                                                                            ...
                                                                            "block px-4 py-2 text-sm text-purple-100"
                                                                        )}
                                                                    >
                                                                        {item.name}
                                                                    </a>
                            ...
                            <Disclosure.Panel className="md:hidden">
                                ...
                                <div className="border-t border-gray-700 pb-3 pt-4">
                                    <div className="flex items-center px-5">
                                        ...
                                        <div className="ml-3">
                                            <div className="text-base font-medium leading-none text-purple-100">{user.name}</div>
                                    ...
                                    <div className="mt-3 space-y-1 px-2">
                                        {userNavigation.map((item) => (
                                            <Disclosure.Button
                                                ...
                                                as="a"
                                                href={item.href}
                                                className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-teal-700 hover:text-purple-100"
                                            >
                                                {item.name}
                                            </Disclosure.Button>
                                        ))}
